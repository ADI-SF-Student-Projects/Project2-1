...
/**
 * DatabaseHelper class is designed to create a database that we then populate with data in the Bar class
 */
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    //region Search Methods By Criteria
    ...
    public Cursor searchBarsByFavorites() {
    ...
    //region Get Column By Id Methods

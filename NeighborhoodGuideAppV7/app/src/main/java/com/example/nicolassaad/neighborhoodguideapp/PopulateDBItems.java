...
/**
 This class populates the data for the bars using an ArrayList and the BarItem class.
 */
public class PopulateDBItems {
    ...
    public static ArrayList<BarItem> getBarItems(Context context) {
        ...
        betalounge.setName(context.getString(R.string.beta_lounge));
        betalounge.setAddress(context.getString(R.string.beta_lounge_address));
        betalounge.setDescription(context.getString(R.string.beta_lounge_desc));
        betalounge.setRating(3.0f);
        betalounge.setPrice(context.getString(R.string.dollarsign1));
        betalounge.setFavorite(0);
        betalounge.setImageResourceID(R.drawable.betaloungeround);
